...
function postSeriesKeyword (res, sid, kid_list, index, callback) {
	app.getConnectionPool((conn) => {
...
exports.updateSeriesKeyword = (res, sid, kid_list, callback) => {
	app.getConnectionPool((conn) => {
...
function postUserKeyword (res, uid, kid_list, index, callback) {
	app.getConnectionPool((conn) => {
