...
exports.recordReadInfo = (res, uid, sid, eid, chapter, date, callback) => {
  app.getConnectionPool((conn) => {
    ...
    var sql = "insert into `READ`(uid, sid, eid, recent_episode, date) values(" + uid + ", " + sid + ", " + eid + ", '" + chapter + "', '" + date + "') on duplicate key update uid=" + uid + ", sid=" + sid + ", eid=" + eid + ", recent_episode='" + chapter + "', date='" + date +"'";
